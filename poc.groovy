      ...
      script {
        ...
        def buildCommandsForSolutions = { List solutions, String bucketLabel ->
          ...
          (solutions ?: []).each { sol ->
            ...
            // 3b) Import project artifacts (.flop + optional maps/data)
            ...
            projects.each { proj ->
              ...
              // Optional maps / data files if present
              ...
              // (If you ever need dataSpecFile and your CLI supports it, wire it here.)
        ...
        def commands = []
        def dynamicsRoot = manifest?.dynamics
        def solutionsNode = dynamicsRoot?.solutions
